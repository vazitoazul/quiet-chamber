...
describe('AuthController', function(){
	describe('register',function(){
		   ...
		   it('should return 409 because of missing param', function (done) {
		    ...
		    it('should return 409 for a wrong email validation', function (done) {
		      request(sails.hooks.http.app)
		        .post('/auth/local/register')
        ...
        it('should register the user and return him already logged in', function (done) {
          request(sails.hooks.http.app)
            .post('/auth/local/register')
